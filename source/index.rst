...
* Redstone ICs (Logic gates, Sensors, `Many others! <https://craftbook.readthedocs.io/en/3.x/mechanics/ics/index.html>`_)
...
Remember that `CraftBook is open source. <https://github.com/EngineHub/CraftBook/tree/3.x>`_
...
-  `CraftBook Homepage <https://enginehub.org/craftbook/>`_
-  `Downloads for Spigot <http://builds.enginehub.org/job/craftbook?branch=3.x>`_
